...
*/
-- DropForeignKey
ALTER TABLE `Review` DROP FOREIGN KEY `Review_productIt_fkey`;
...
-- AddForeignKey
ALTER TABLE `reviews` ADD CONSTRAINT `reviews_productIt_fkey` FOREIGN KEY (`productIt`) REFERENCES `products`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
